...
#define MQTT_HOST           "120.79.64.223" // "192.168.1.119" the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT           1883    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID        "aiker"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
#define MQTT_USER            "uaer" // your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS            "12345" // you MQTT login password, same as above
#define STA_SSID "Signal_Process"    // your AP/router SSID to config your device networking
#define STA_PASS "zhanglaoshidianhuahaoma" // your AP/router password
